            ...
            children: [
              ...
              AnimatedBuilder(
                ...
                child: TextField(
                  ...
                  // ← string عادي — مش digits only عشان الكود ممكن يكون حروف وأرقام
...
class _Banner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isError
            ? const Color(0xFFFFEEEE) : const Color(0xFFE8FFF0),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isError
              ? const Color(0xFFFFCDD2) : const Color(0xFFA5D6B0),
          width: 1,
        ),
      ),
      child: Row(
        children: [
          Icon(
            ...
            color: isError
                ? const Color(0xFFE74C3C) : const Color(0xFF2E7D32),
            size: 18,
          ),
